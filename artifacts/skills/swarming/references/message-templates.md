...
All workers: join this thread, post startup acknowledgment, then load the exploringexecuting skill.
...
AGENTS.md: read
Status: Loading exploringexecuting skill.
...
Next step: Invoke the exploringreviewing skill.
```
...
{
  "schema_version": "1.0",
  "format": "qd-swarm-handoff",
  "session": {
    "id": "qd-swarm-<YYYYMMDD-HHMMSS>",
