...
- Pressure-testing guidance from `../writing-qd-skills/SKILL.md`
...
- The tightened trigger line follows `writing-qd-skills` more closely and reduces the risk that agents treat the description as a workflow substitute.
