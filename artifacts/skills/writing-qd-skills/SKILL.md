...
- Create any new skill for the qd ecosystem
...
description: Use when creating a new qd skill or editing an existing one
```
...
bash scripts/check-markdown-links.sh <skill-name>/SKILL.md
