...
### 1. Obvious Comments (EXCLUDE: BDD comments like #given, #when, #then)
...
- Verbose, duplicated, or redundant code
...
- Complex ternary → explicit if-else
...
**Why this is slop**: [Explain why problematic]
**Why safe to remove**: [Explain why functionality preserved]
...
**Defensive Code**: Null checks present are appropriate
